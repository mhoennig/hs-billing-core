...
// if inline is removed, jacoco does not recognize callers code-coverage
inline fun validationError(message: String, cause: Throwable): Nothing =
    throw IllegalStateException(message, cause)

// if inline is removed, jacoco does not recognize callers code-coverage
inline fun validationError(message: String): Nothing =
